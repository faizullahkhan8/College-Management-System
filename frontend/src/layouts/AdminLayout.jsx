  ...
  return (
    <div className="h-screen overflow-hidden bg-slate-100">
      ...
      <div className="flex h-[calc(100vh-57px)] lg:h-screen">
        <div
          className={`fixed lg:static z-50 h-full transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
            }`}
        >
          <Sidebar
            collapsed={collapsed}
          ...
          >
            <div className="px-4 py-5 border-b border-green-200 flex items-center justify-between">
              {!collapsed && (
                <div>
                  <h2 className="text-green-900 font-semibold text-lg">Fees & Attandance Management System</h2>
                </div>
              )}
              <button
