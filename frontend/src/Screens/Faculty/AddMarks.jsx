...
const AddMarks = () => {
    ...
    const searchStudents = async () => {
        ...
        try {
            ...
            toast.dismiss();
            toast.error(
                error.response?.data?.message || "Error searching students",
            );
    ...
    const handleSubmit = async () => {
        ...
        const hasEmptyMarks = Object.values(marksData).some(
            (mark) => mark === "",
        );
        if (hasEmptyMarks) {
        ...
        try {
            ...
            toast.error(
                error.response?.data?.message || "Error submitting marks",
            );
                ...
                <div className="w-full mt-8">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                <div className="border p-3 rounded-md shadow">
                                    ...
                                    <p className="text-gray-800">
                                        {selectedBranch?.branchId} - Semester{" "}
                                        {selectedSemester}
                                    </p>
                                </div>
                    ...
                    <div className="flex justify-between items-center mt-6 p-4 bg-gray-50 border rounded-lg">
                        <div className="flex items-center gap-2">
                            ...
                            >
                                I confirm that all marks entered are correct and
                                verified
                            </label>
                        </div>
