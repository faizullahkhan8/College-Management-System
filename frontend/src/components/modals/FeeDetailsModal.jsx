...
import { FiX, FiFileText, FiDollarSign, FiUsers, FiCheck, FiCalendar, FiEye } from "react-icons/fi";
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="bg-linear-to-r from-purple-50 to-blue-50 rounded-lg p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <span className="text-sm text-gray-600">Last Date</span>
                                    <p className="text-lg font-semibold">
                                        {formatDate(feeDetails.feeStructure.lastDate)}
                                    </p>
                                </div>
                                <div>
                            ...
                            <div className="bg-white border rounded-lg p-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold">{feeDetails.statistics.totalTargeted}</p>
                                    </div>
                            ...
                            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-green-600">{feeDetails.statistics.paidStudents}</p>
                                    </div>
                            ...
                            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-yellow-600">{feeDetails.statistics.pendingStudents}</p>
                                    </div>
                            ...
                            <div className="bg-gray-50 border rounded-lg p-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-gray-600">{feeDetails.statistics.unpaidStudents}</p>
                                    </div>
                            ...
                            <div className="mt-4">
                                <div className="w-full bg-gray-200 rounded-full h-3">
                                    <div 
                                        ...
                                        style={{ width: `${feeDetails.revenue.collectionRate}%` }}
                                    />
                                </div>
                                <p className="text-sm text-gray-600 mt-1">
                                    {feeDetails.revenue.collectionRate}% of expected revenue collected
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-2 border-b">
                            {["all", "paid", "pending", "rejected", "unpaid"].map((filter) => (
                                <button
                                    key={filter}
                                ...
                                >
                                    ...
                                    {filter !== "all" && (
                                        <span className="ml-2 px-2 py-0.5 bg-gray-100 text-gray-700 text-xs rounded-full">
                                            {filter === "paid" ? feeDetails.statistics.paidStudents :
                                             filter === "pending" ? feeDetails.statistics.pendingStudents :
                                             filter === "rejected" ? feeDetails.statistics.rejectedStudents :
                                             feeDetails.statistics.unpaidStudents}
                                        </span>
                                    )}
                                </button>
                            ))}
                        ...
                        <div className="bg-white border rounded-lg">
                            <div className="max-h-96 overflow-y-auto">
                                {feeDetails.students
                                    .filter(student => 
                                        detailsFilter === "all" || 
                                        student.paymentStatus === detailsFilter.toUpperCase()
                                    )
                                    .map((student) => (
                                        <div key={student.studentId} className="p-4 border-b last:border-b-0 hover:bg-gray-50">
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    {student.studentInfo && (
                                                        <div className="text-sm text-gray-500">
                                                            {student.studentInfo.enrollmentNo}
                                                        </div>
                                                    )}
                                                </div>
                        ...
                        {feeDetails.recentPayments.length > 0 && (
                            <div className="bg-white border rounded-lg p-6">
                                ...
                                <div className="space-y-3">
                                    {feeDetails.recentPayments.map((payment) => (
